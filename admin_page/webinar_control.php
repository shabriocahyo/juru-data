          ...
          <main>
            <div class="container mt-4">
              ...
              <div class="input-group mb-3">
                ...
                <button class="btn btn-success" onclick="location.href='tambah_user.php'">Tambah User</button>
              </div>
                    ...
                    if ($result->num_rows > 0) {
                      ...
                      while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td class='text-center'>
                                <a href='edit_user.php?id_user=" . $row["id_user"] . "' class='btn btn-primary btn-sm me-2 bi bi-pencil-square'></a>
                                <a href='hapus_user.php?id_user=" . $row["id_user"] . "' class='btn btn-danger btn-sm bi bi-trash'></a>
                              </td>";
                        echo "</tr>";
                      }
                    } else {
